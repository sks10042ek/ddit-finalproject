...
$(function(){
    ...
    let trTag = `
        <tr>
            ...
            <td id="cqteItUprc"><input type="number" class="findCqteItUprc_${index}" id="findCqteItUprc" style="width: 100px;" /></td>
	...
	$(document).on('click', '#upreqCd a', function(e) {
		...
		autoBinding.addEventListener('click', function() {
		    ...
		    document.querySelector('.findCqteItUprc_0').value = '800000';
		    document.querySelector('.findCqteItUprc_1').value = '50000';
